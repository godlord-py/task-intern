...
const StudentPortal = () => {
  ...
  return (
    ...
    <header className={`shadow-sm flex justify-between p-4 ${theme === 'dark' ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'}`}>
      ...
      <div className="flex">
      <aside className={`${isSidebarOpen ? 'w-64' : 'w-16'} transition-all p-4 
  ...
  <button className="flex items-center space-x-3 p-3 rounded-lg w-full mt-8 
    ${theme === 'dark' ? 'text-red-400 hover:bg-red-700' : 'text-red-600 hover:bg-red-50'}" 
